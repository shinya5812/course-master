  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-5 text-center">
        <p className="text-xs font-mono tracking-widest text-gold uppercase">Coming Soon</p>
        <h1 className="mt-4 font-serif text-3xl font-bold text-gold-gradient">的中実績</h1>
        <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
          このページは現在準備中です。<br />
          的中実績・収支レポートは近日公開予定です。
        </p>
        <a
          href="/"
