...
"""
db_update_0603.py
2026-06-03 DB更新スクリプト
  Step 1: 結果202605300531.csv を race_results にINSERT（重複チェック込み）
  Step 2: 血統0603.csv を blood_map にUPSERT
  Step 3: 統計マスター全再集計
"""
...
NEW_RACE_CSV  = os.path.join(RACE_DIR, '結果202605300531.csv')
NEW_BLOOD_CSV = os.path.join(PED_DIR,  '血統0603.csv')
