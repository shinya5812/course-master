...
def print_result(race: dict, prediction: dict, chaos: dict):
    ...
    edge_ok    = (honmei_edge is not None) and (honmei_edge >= edge_threshold) and (honmei_dist < 2200)
    edge_ng_ld = (honmei_edge is not None) and (honmei_edge >= edge_threshold) and (honmei_dist >= 2200)
    if edge_ok:
